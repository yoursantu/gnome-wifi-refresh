...
A lightweight GNOME Shell extension that adds a **Refresh Network** button directly inside the Wi-Fi menu.  
It allows users to quickly rescan Wi-Fi networks and automatically reconnect to known networks — without reopening the network menu.
